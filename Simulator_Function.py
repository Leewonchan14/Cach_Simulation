...
import random
Perfomance = {}
def Fucntion(s,b,size,allocate_type,write_type,Out_type,filename):
  # s = 2
  # b = 2
  # size = 4
  ...
  # print(f"Total Miss : {Load_miss+Store_miss}")
  # print(f"Perfomance = Total hit / Total Cycle : {(Load_hit+Store_hit)/Total_cycle}")
  s_s = str(s)
  s_b = str(b)
  s_size = str(size)
